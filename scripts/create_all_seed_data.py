...
print("\n🚀 BULK GENERATORS AVAILABLE (200+ to 10k+ entries each):")
print("   python scripts/generate_normalization_rules.py --count 250")
print("   python scripts/generate_profanity_list.py --count 160")
print("   python scripts/generate_challenge_set.py --count 320")
print("   python scripts/generate_monolingual_ht.py --count 12000")
print("   python scripts/generate_monolingual_en.py --count 12000")
print("\n📝 Next steps:")
...
print("3. Run bulk generators above for expanded datasets")
print("4. Ingest all: python src/data/ingest_sources.py [file.csv] --type [type]")
